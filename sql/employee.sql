...
(
   ...
   REWARD               text comment '奖励记录 JSON',
   PUNISH               text comment '处罚记录 JSON',
   SALARY               varchar(500) comment '合同薪资 ',
   IMG_PHOTO            text comment '照片',
   IMG_ID               text comment '身份证',
   IMG_EDU              text comment '学历证书',
