...
(
   ...
   DEPART_DATE_FROM     datetime comment '出发日期-从',
   DEPART_DATE_TO       datetime comment '出发日期-至',
   ...
   FOLLOWR_NO_ROOM_NUM  integer comment '跟团(不占位)',
   FOLLOWR_NO_ROOM_SERVICE varchar(500) comment '跟团(不占位)-服务',
   FOLLOWR_NO_ROOM_REMARK varchar(500) comment '跟团(不占位)-内注',
