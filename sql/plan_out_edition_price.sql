...
(
   ...
   MUST_PRICE           integer comment '必购  0(false)-否 1(true)-是',
   MUST_PRICE_NAME      varchar(500) comment '必购名称',
   MUST_PRICE_AMOUNT    decimal(15,2) comment '必购金额',
   CHOOSE_PRICE         integer comment '选购   0(false)-否 1(true)-是',
   CHOOSE_PRICE_NAME    varchar(500) comment '选购名称',
   CHOOSE_PRICE_AMOUNT  decimal(15,2) comment '选购金额',
   ADDITIONAL_PRICE     integer comment '附加    0(false)-否 1(true)-是',
   ADDITIONAL_PRICE_NAME varchar(500) comment '附加名称',
   ADDITIONAL_PRICE_AMOUNT decimal(15,2) comment '附加金额',
