...
(
   ...
   GUIDANCE_PRICE_DELTA decimal(15,2) comment '指导代理价-差价',
   AGENCY_PRICE_2       decimal(15,2) comment '二级代理价',
   AGENCY_PRICE_2_DELTA decimal(15,2) comment '二级代理价-差价',
   AGENCY_PRICE_1       decimal(15,2) comment '一级代理价',
   AGENCY_PRICE_1_DELTA decimal(15,2) comment '一级代理价-差价',
